// This file mostly exists because we want dev mode to say "Snocode (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Snocode (Dev)" : "Snocode (Alpha)";
const APP_BUNDLE_ID = isDevelopment ? "io.snowcode.snocode.dev" : "io.snowcode.snocode";
