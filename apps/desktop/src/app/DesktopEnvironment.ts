...
export interface DesktopEnvironmentShape {
  ...
  readonly devRemoteSnocodeServerEntryPath: Option.Option<string>;
...
>()("snocode/desktop/Environment") {}

const APP_BASE_NAME = "Snocode";
...
const makeDesktopEnvironment = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = Option.getOrElse(config.snocodeHome, () => path.join(homeDirectory, ".snocode"));
  ...
  const userDataDirName = isDevelopment ? "snocode-dev" : "snocode";
  const legacyUserDataDirName = isDevelopment ? "Snocode (Dev)" : "Snocode (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    devServerUrl,
    devRemoteSnocodeServerEntryPath: config.devRemoteSnocodeServerEntryPath,
    ...
    branding,
    displayName,
    appUserModelId: isDevelopment ? "io.snowcode.snocode.dev" : "io.snowcode.snocode",
    linuxDesktopEntryName: isDevelopment ? "snocode-dev.desktop" : "snocode.desktop",
    linuxWmClass: isDevelopment ? "snocode-dev" : "snocode",
    userDataDirName,
