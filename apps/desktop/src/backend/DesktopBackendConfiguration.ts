...
>()("snocode/desktop/BackendConfiguration") {}
...
const DESKTOP_BACKEND_ENV_NAMES = [
  ...
  "SNOCODE_NO_BROWSER",
  "SNOCODE_HOST",
  "SNOCODE_DESKTOP_WS_URL",
  "SNOCODE_DESKTOP_LAN_ACCESS",
  "SNOCODE_DESKTOP_LAN_HOST",
  "SNOCODE_DESKTOP_HTTPS_ENDPOINTS",
  "SNOCODE_TAILSCALE_SERVE",
  "SNOCODE_TAILSCALE_SERVE_PORT",
] as const;
  ...
  > {
    ...
    return {
      ...
      bootstrap: {
        ...
        snocodeHome: environment.baseDir,
