...
import { resolveRemoteSnocodeCliPackageSpec } from "@snocode/ssh/command";
import type { RemoteSnocodeRunnerOptions } from "@snocode/ssh/tunnel";
...
const resolveDesktopSshCliRunner = (
...
): RemoteSnocodeRunnerOptions => {
  const devRemoteEntryPath = Option.getOrUndefined(environment.devRemoteSnocodeServerEntryPath);
  ...
  return {
    packageSpec: resolveRemoteSnocodeCliPackageSpec({
