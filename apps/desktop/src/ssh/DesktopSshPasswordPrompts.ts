import type { DesktopSshPasswordPromptRequest } from "@snocode/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@snocode/contracts";
import type { SshPasswordRequest } from "@snocode/ssh/auth";
...
const WINDOW_UNAVAILABLE_MESSAGE = "Snocode window is not available for SSH authentication.";
...
>()("snocode/desktop/SshPasswordPrompts") {}
