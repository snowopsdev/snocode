import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@snocode/contracts";
...
import { KeybindingsConfigError } from "@snocode/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "snocode-keybindings-test-",
        }),
      ),
    ),
  );
