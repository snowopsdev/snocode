...
import { makeDrainableWorker } from "@snocode/shared/DrainableWorker";
...
const STRICT_PROVIDER_LIFECYCLE_GUARD = process.env.SNOCODE_STRICT_PROVIDER_LIFECYCLE_GUARD !== "0";
