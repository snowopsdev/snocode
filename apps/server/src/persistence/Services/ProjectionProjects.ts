 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@snocode/contracts";
...
>()("snocode/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
