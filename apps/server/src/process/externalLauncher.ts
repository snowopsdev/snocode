...
import { isCommandAvailable, type CommandAvailabilityOptions } from "@snocode/shared/shell";
...
export { isCommandAvailable } from "@snocode/shared/shell";
...
export class ExternalLauncher extends Context.Service<ExternalLauncher, ExternalLauncherShape>()(
  "snocode/process/ExternalLauncher",
) {}
