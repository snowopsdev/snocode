...
>()("snocode/provider/ProviderMaintenanceRunner") {}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Snocode could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Snocode still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
