...
import { VcsProcessExitError } from "@snocode/contracts";
  ...
  it.effect("parses merge request view output", () =>
    Effect.gen(function* () {
        ...
        Effect.succeed(
          processOutput(
            ...
            JSON.stringify({
              ...
              web_url: "https://gitlab.com/pingdotgg/snocode/-/merge_requests/42",
              target_branch: "main",
              ...
              source_project: {
                path_with_namespace: "octocat/snocode",
              },
            }),
          ),
        ),
      ...
      assert.deepStrictEqual(result, {
        number: 42,
        title: "Add MR thread creation",
        url: "https://gitlab.com/pingdotgg/snocode/-/merge_requests/42",
        baseRefName: "main",
            ...
            JSON.stringify([
              {
                iid: 0,
                title: "invalid",
                web_url: "https://gitlab.com/pingdotgg/snocode/-/merge_requests/0",
                target_branch: "main",
              ...
              },
              {
                iid: 43,
                title: "  Valid MR  ",
                web_url: " https://gitlab.com/pingdotgg/snocode/-/merge_requests/43 ",
                target_branch: " main ",
      ...
      assert.deepStrictEqual(result, [
        {
          number: 43,
          title: "Valid MR",
          url: "https://gitlab.com/pingdotgg/snocode/-/merge_requests/43",
          baseRefName: "main",
    ...
    Effect.gen(function* () {
      mockedRun.mockReturnValueOnce(
        Effect.succeed(
          processOutput(
            ...
            JSON.stringify({
              path_with_namespace: "octocat/snocode",
              web_url: "https://gitlab.com/octocat/snocode",
              http_url_to_repo: "https://gitlab.com/octocat/snocode.git",
              ssh_url_to_repo: "git@gitlab.com:octocat/snocode.git",
            }),
          ),
        ),
      );
      ...
      const result = yield* Effect.gen(function* () {
        ...
        return yield* glab.getRepositoryCloneUrls({
          cwd: "/repo",
          repository: "octocat/snocode",
        });
      });

      assert.deepStrictEqual(result, {
        nameWithOwner: "octocat/snocode",
        url: "https://gitlab.com/octocat/snocode",
        sshUrl: "git@gitlab.com:octocat/snocode.git",
      });
    }),
  );
  ...
  it.effect("creates merge requests through the GitLab API without placing the body in argv", () =>
    Effect.gen(function* () {
      ...
      yield* glab.createMergeRequest({
        ...
        title: "Provider MR",
        bodyFile: "/tmp/snocode-mr-body.md",
      });
      ...
      expect(mockedRun).toHaveBeenCalledWith(
        expect.objectContaining({
          ...
          args: [
            ...
            "title=Provider MR",
            "--field",
            "description=@/tmp/snocode-mr-body.md",
          ],
        }),
      );
    }),
