...
export const makeVcsDriverShape = Effect.fn("makeGitVcsDriverShape")(function* () {
  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(gitCommonDir, `snocode-checkpoint-index-${randomUUID()}`);
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "Snocode",
        GIT_AUTHOR_EMAIL: "snocode@users.noreply.github.com",
        GIT_COMMITTER_NAME: "Snocode",
        GIT_COMMITTER_EMAIL: "snocode@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `snocode checkpoint ref=${input.checkpointRef}`;
