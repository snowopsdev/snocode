...
import { GitCommandError, type VcsRef } from "@snocode/contracts";
import { dedupeRemoteBranchesWithLocalMatches } from "@snocode/shared/git";
import { compactTraceAttributes } from "@snocode/shared/observability";
import { decodeJsonResult } from "@snocode/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `snocode-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
