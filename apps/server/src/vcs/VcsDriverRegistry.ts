...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@snocode/contracts";
import { VcsUnsupportedOperationError } from "@snocode/contracts";
