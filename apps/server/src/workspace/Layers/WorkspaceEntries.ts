...
import { type FilesystemBrowseInput, type ProjectEntry } from "@snocode/contracts";
import { isExplicitRelativePath, isWindowsAbsolutePath } from "@snocode/shared/path";
import {
  insertRankedSearchResult,
  normalizeSearchQuery,
  scoreQueryMatch,
  type RankedSearchResult,
} from "@snocode/shared/searchRanking";
