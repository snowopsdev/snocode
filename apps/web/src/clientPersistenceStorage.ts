...
export const CLIENT_SETTINGS_STORAGE_KEY = "snocode:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "snocode:saved-environment-registry:v1";
