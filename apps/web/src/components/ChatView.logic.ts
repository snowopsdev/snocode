...
export const LAST_INVOKED_SCRIPT_BY_PROJECT_KEY = "snocode:last-invoked-script-by-project";
...
export function deriveComposerSendState(options: {
  ...
  browserPreviewContextCount?: number;
}): {
  ...
  return {
    ...
    hasSendableContent:
      ...
      (options.browserPreviewContextCount ?? 0) > 0,
  };
}
