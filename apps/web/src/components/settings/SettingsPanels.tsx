...
import { scopeThreadRef } from "@snocode/client-runtime";
import { DEFAULT_UNIFIED_SETTINGS } from "@snocode/contracts/settings";
  ...
  return (
    <SettingsPageContainer>
      <SettingsSection title="General">
        <SettingsRow
          title="Theme"
          description="Choose how Snocode looks across the app."
          resetAction={
            theme !== "system" ? (
