...
import { applyGitStatusStreamEvent } from "@snocode/shared/git";
...
export interface WsRpcClient {
  ...
  readonly projects: {
    ...
    readonly createFolder: RpcUnaryMethod<typeof WS_METHODS.projectsCreateFolder>;
...
export function createWsRpcClient(transport: WsTransport): WsRpcClient {
  return {
    ...
    projects: {
      ...
      createFolder: (input) =>
        transport.request((client) => client[WS_METHODS.projectsCreateFolder](input)),
      writeFile: (input) =>
