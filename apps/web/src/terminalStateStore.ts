...
import { parseScopedThreadKey, scopedThreadKey } from "@snocode/client-runtime";
import { type ScopedThreadRef, type TerminalEvent } from "@snocode/contracts";
...
const TERMINAL_STATE_STORAGE_KEY = "snocode:terminal-state:v1";
