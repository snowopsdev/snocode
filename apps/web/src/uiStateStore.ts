...
export const PERSISTED_STATE_KEY = "snocode:ui-state:v1";
const LEGACY_PERSISTED_STATE_KEYS = [
  "snocode:renderer-state:v8",
  "snocode:renderer-state:v7",
  "snocode:renderer-state:v6",
  "snocode:renderer-state:v5",
  "snocode:renderer-state:v4",
  "snocode:renderer-state:v3",
