...
export const WsProjectsCreateFolderRpc = Rpc.make(WS_METHODS.projectsCreateFolder, {
  payload: ProjectCreateFolderInput,
  success: ProjectCreateFolderResult,
  error: ProjectCreateFolderError,
});
