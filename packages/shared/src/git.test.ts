import type { VcsStatusRemoteResult, VcsStatusResult } from "@snocode/contracts";
...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:snowopsdev/snocode.git")).toBe(
      "github.com/snowopsdev/snocode",
    );
    expect(normalizeGitRemoteUrl("https://github.com/snowopsdev/snocode.git")).toBe(
      "github.com/snowopsdev/snocode",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/snowopsdev/snocode")).toBe(
      "github.com/snowopsdev/snocode",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:snowopsdev/platform/snocode.git")).toBe(
      "gitlab.com/snowopsdev/platform/snocode",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/snowopsdev/platform/snocode.git")).toBe(
      "gitlab.com/snowopsdev/platform/snocode",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:snowopsdev/snocode.git"),
    ).toBe("snowopsdev/snocode");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/snowopsdev/snocode.git"),
    ).toBe("snowopsdev/snocode");
  });
});
