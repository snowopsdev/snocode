...
it.layer(NodeServices.layer)("build-desktop-artifact", (it) => {
  ...
  it("switches desktop packaging product names to nightly for nightly builds", () => {
    assert.equal(resolveDesktopProductName("0.0.17"), "Snocode (Alpha)");
    assert.equal(resolveDesktopProductName("0.0.17-nightly.20260413.42"), "Snocode (Nightly)");
  });
      ...
      resolveDesktopRuntimeDependencies(
        {
          ...
          "@snocode/contracts": "workspace:*",
          "@snocode/shared": "workspace:*",
          "@snocode/ssh": "workspace:*",
          "@snocode/tailscale": "workspace:*",
          effect: "catalog:",
          electron: "41.5.0",
        },
        {
        ...
        Effect.provide(
          ConfigProvider.layer(
            ConfigProvider.fromEnv({
              env: {
                SNOCODE_DESKTOP_SKIP_BUILD: "true",
                SNOCODE_DESKTOP_KEEP_STAGE: "true",
                SNOCODE_DESKTOP_SIGNED: "true",
                SNOCODE_DESKTOP_VERBOSE: "true",
                SNOCODE_DESKTOP_MOCK_UPDATES: "true",
              },
            }),
          ),
        ),
