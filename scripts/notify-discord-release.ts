  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Snocode prerelease is available for nightly testers."
          : "A new Snocode latest release is available.",
...
).pipe(Command.withDescription("Post a Snocode release announcement to Discord."));
